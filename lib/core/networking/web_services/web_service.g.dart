...
class _WebService implements WebService {
  ...
  Future<Characters> getAllCharacters() async {
    ...
    final _options = _setStreamType<Characters>(
    ...
    late Characters _value;
    try {
      _value = Characters.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<Characters> getCharactersByPage(int page) async {
    final _extra = <String, dynamic>{};
